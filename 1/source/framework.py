...
app.wizard = {'Captain': {'Move': 5, 'Fight': 2, 'Shoot': 2, 'Shield': 12, 'Morale': 4, 'Health': 12, 'Cost': 0,
                          'Skillset': [], 'Specialism': None, 'Items': [], # consistency between Captain
                          'Experience': 0}} # and Ensign
app.apprentice = {'Ensign': {'Move': 7, 'Fight': 0, 'Shoot': -1, 'Shield': 10, 'Morale': 2, 'Health': 8,
...
app.weapon = ['Blaster', 'Needle Gun', 'Blade', 'Cannon', 'Whip']  # These two should be
app.cost = {'Blaster': 5, 'Needle Gun': 12, 'Blade': 3, 'Cannon': 15, 'Whip': 5}  # merged together?
